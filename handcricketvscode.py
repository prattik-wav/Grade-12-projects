...
def main(game_manager, game_state):
    ...
    while True:
        ...
        if choice == "tutorial":
            ...
            commentator = Commentator(game_state.get("commentary_enabled", True))
            gameplay = GamePlay(name, min_choice, max_choice, score_alignment, game_state.difficulty, commentator)

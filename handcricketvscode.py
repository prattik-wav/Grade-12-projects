    ...
    def save_profile(self, profile: dict, player_name: str = "", password: str = None):
        ...
        sql = """
              ...
              (name, password, lifetime_runs, lifetime_wickets, total_matches,
               total_wins, total_losses, total_draws, avg_runs, total_balls_faced, total_balls_bowled, lifetime_runs_conceded,
...
def main(game_manager):
    ...
    while True:
        ...
        if choice == "tutorial":
            ...
            manager.save_profile_and_match_data(game_var['player_profile'], all_match_data)

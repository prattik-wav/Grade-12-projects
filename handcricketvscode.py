...
class LeaderboardManager:
    ...
    def show_menu(self):
        while True:
            ...
            print("1. Most Runs Scored")
            print("2. Most Wickets Taken")
            print("3. Most Balls Played")
            print("4. Most Active Players (Matches Played)")
            print("5. Highest Scores Scored")
            print("6. Most Win Rate")
            print("7. Highest All-Rounders Scores")
            print("8. Most Lifetime Run Rate")
            print("9. Most Lifetime Strike Rate") 
            print("10. Most Lifetime Economy Rate") 
            print("11. Most Half Centuries")
            print("12. Most Centuries") 
    ...
    def leaderboard_info(self):
        ...
        print("0. Show Leaderboard info")
        print("1. Most Runs Scored: Total runs scored by a player in all matches.")
        print("2. Most Wickets Taken: Total wickets taken by a player in all matches.")
        print("3. Most Balls Played: Total balls faced by a player in all matches.")
        print("4. Most Active Players: Players with the most matches played.")
        print("5. Highest Scores Scored: Highest individual score by a player in all matches.")
        print("6. Most Win Rate: Percentage of matches won by a player.")
        print("7. Highest All-Rounders Scores: Combined score of runs and wickets for all-rounders.")
        print("8. Most Lifetime Run Rate: Average runs scored per ball faced by a player.")
        print("9. Most Lifetime Strike Rate: Average runs scored per 100 balls faced by a player.")
        print("10. Most Lifetime Economy Rate: Average runs conceded per 6 balls bowled by a player.")
        print("11. Most Half Centuries: Total half-centuries scored by a player.")
        print("12. Most Centuries: Total centuries scored by a player.")
        print("13. Return to the Main Menu")
    ...
    def show_win_rate(self):
        ...
        print(f"{'Rank':<6}{'Player':<20}{'Win Rate':<12}{'Record (W/M)':<15}")
        print("-" * 50)
    
        for i, row in enumerate(results, 1):
            player_name, wins, matches, win_rate = row
            print(f"{i:<6}{player_name.upper()[:15]:<20}{win_rate}%{'':<7}{wins}/{matches}{'':10}")
    ...
    def show_lifetime_run_rate(self):
        ...
        print(f"{'Rank':<6}{'Player':<20}{'Run Rate':<12}{'Runs/Balls':<15}")
        print("-" * 50)
        
        for i, row in enumerate(results, 1):
            player_name, lifetime_runs, lifetime_balls_faced, lifetime_run_rate = row
            print(f"{i:<6}{player_name.upper()[:15]:<20}{lifetime_run_rate:<12}{lifetime_runs}/{lifetime_balls_faced}")
    ...
    def show_lifetime_strike_rate(self):
        ...
        print(f"{'Rank':<6}{'Player':<20}{'SR':<10}{'Runs/Balls':<15}")
        print("-" * 50)

        for i, row in enumerate(results, 1):
            player_name, lifetime_runs, lifetime_balls_faced, strike_rate = row
            print(f"{i:<6}{player_name.upper()[:15]:<20}{strike_rate:<10}{lifetime_runs}/{lifetime_balls_faced}")
    ...
    def show_lifetime_economy_rate(self):
        ...
        print(f"{'Rank':<6}{'Player':<20}{'ER':<10}{'Runs Conceded/Balls Bowled':<30}")
        print("-" * 60)

        for i, row in enumerate(results, 1):
            player_name, lifetime_runs_conceded, lifetime_balls_bowled, lifetime_economy_rate = row
            print(f"{i:<6}{player_name.upper()[:15]:<20}{lifetime_economy_rate:<10}{lifetime_runs_conceded}/{lifetime_balls_bowled}")
            ...
            if db_handler.player_exists(name):
                ...
                for attempt in range(3):
                    ...
                    if entered_pass == stored_password:
                        ...
                        print(f"Incorrect password. You have {3 - i} attempts left.")
